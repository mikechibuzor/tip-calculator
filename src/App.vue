<template>
  <div class="akin w-screen h-screen flex flex-col items-center justify-center bg-light-grayish-cyan1">
    ...
    <div class="tip-calculator-container grid grid-cols-2 px-8 py-6 gap-x-10 mt-16 h-height60 2xl:h-height50 w-3/5  bg-white rounded-3xl">
      <div class="first-half rounded-xl ">
        <div class="bill">
          ...
          <div class="input-box relative flex items-center ">
            ...
            <input type="text" class="w-full outline-none text-right font-bold text-very-dark-cyan text-xl font-space-mono py-2 pl-8 pr-4 transition-all duration-300 ease-in-out rounded bg-light-grayish-cyan2" placeholder="0">
          </div>
        </div>
        ...
        <div class="select-tip mt-8">
            ...
            <div class="options grid grid-cols-3 gap-x-4 gap-y-4">
              <button class="rounded-md hover:bg-light-grayish-cyan1  hover:text-very-dark-cyan duration-100 ease-linear px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">5%</button>
              <button class="rounded-md hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">10%</button>
              <button class="rounded-md hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">15%</button>
              <button class="rounded-md hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">25%</button>
              <button class="rounded-md hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">50%</button>
              <input type="text" placeholder="Custom" class="outline-none bg-light-grayish-cyan2 px-4 py-1.5 rounded"/>
            </div>
        </div>
      ...
      <div class="second-half flex flex-col justify-between rounded-xl bg-very-dark-cyan shadow-sm p-8">
       ...
       <div class="reset-button">
         <button class="outline-none hover:bg-light-grayish-cyan1  hover:text-very-dark-cyan duration-100 ease-linear border-none text-very-dark-cyan font-space-mono font-bold bg-strong-cyan w-full px-8 py-2.5 rounded text-lg">RESET</button>
       </div>
      </div>
    </div>
