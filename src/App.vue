<template>
  <div class="akin w-screen h-screen flex flex-col items-center justify-center bg-light-grayish-cyan1">
    ...
    <div class="tip-calculator-container shadow grid grid-cols-2 px-8 py-6 gap-x-10 mt-16 h-height60 2xl:h-height50 w-3/5  bg-white rounded-3xl">
      <div class="first-half rounded-xl ">
        <div class="bill">
          ...
          <div class="input-box relative flex items-center ">
            ...
            <input type="text" class="w-full outline-none  py-2.5 pl-8 pr-4 transition-all duration-300 ease-in-out rounded bg-light-grayish-cyan2" placeholder="0">
          </div>
        </div>
        ...
        <div class="select-tip mt-8">
            ...
            <div class="options grid grid-cols-3 gap-x-4 gap-y-4">
              <button class="rounded-md px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">5%</button>
              <button class="rounded-md px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">10%</button>
              <button class="rounded-md px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">15%</button>
              <button class="rounded-md px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">25%</button>
              <button class="rounded-md px-4 py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan ">50%</button>
      ...
      <div class="second-half rounded-xl bg-very-dark-cyan shadow-sm">
