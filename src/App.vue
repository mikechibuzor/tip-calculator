<template>
  <div class="akin w-screen xl:h-screen flex flex-col items-center justify-center bg-light-grayish-cyan1" @click.self="activeButtonHandler">
    ...
    <div class="tip-calculator-container grid grid-cols-1 xl:grid-cols-2 px-8 py-6 2xl:py-12 gap-x-10 gap-y-10 mt-8 xl:mt-16 xl:h-height55 2xl:h-height50 xl:w-3/5  bg-white rounded-xl xl:rounded-3xl">
      <div id="first-half" class="first-half  rounded-xl ">
        <div class="bill">
          <label for="bill" class="font-space-mono text-dark-grayish-cyan1 2xl:text-lg 2xl:mb-2.5 font-bold block mb-1.5">Bill</label>
          <div class="input-box relative flex items-center ">
            ...
            <input v-model="bill" type="text" class="w-full outline-none text-right font-bold text-very-dark-cyan text-xl font-space-mono 2xl:py-5 py-2 pl-8 2xl:pl-16 pr-4 transition-all duration-300 ease-in-out rounded bg-light-grayish-cyan2" placeholder="0">
          </div>
        </div>

        <!-- select tip % -->
        <div class="select-tip mt-8 2xl:mt-16">
            <label for="tip" class="font-space-mono text-dark-grayish-cyan1 2xl:text-lg 2xl:mb-2.5 font-bold block mb-1.5">Select Tip %</label>
        ...
        <!-- number of people -->
        <div class="number-of-people mt-6 2xl:mt-16">
          <div class="div flex items-center justify-between">
            ...
            <div class="input-box relative flex items-center ">
              ...
              <input v-model="numberOfPeople" type="number" min="0" :class="validateError" class="w-full outline-none text-right font-bold text-very-dark-cyan text-xl font-space-mono 2xl:py-5 py-2 pl-8 2xl:pl-16 pr-4 transition-all duration-300 ease-in-out rounded bg-light-grayish-cyan2" placeholder="0" @change="numberOfPeopleHandler" @keyup="numberOfPeopleHandler">
            </div>         
        </div>
      </div>
