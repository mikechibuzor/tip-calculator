      ...
      <div id="first-half" class="first-half  rounded-xl ">
        <div class="bill">
          ...
          <div class="input-box relative flex items-center ">
            ...
            <input v-model="bill" type="text" class="w-full outline-none text-right font-bold text-very-dark-cyan text-xl font-space-mono 2xl:py-3.5 3xl:py-5 py-2 pl-8 2xl:pl-16 pr-4 transition-all duration-300 ease-in-out rounded bg-light-grayish-cyan2" placeholder="0">
          </div>
        </div>
        ...
        <div class="select-tip mt-8 2xl:mt-9 3xl:mt-16">
            ...
            <div class="options grid grid-cols-3 gap-x-4 2xl:gap-x-6 gap-y-4">
              ...
              <input type="text" v-model="customTip"  placeholder="Custom" class="custom outline-none font-space-mono bg-light-grayish-cyan2 px-4 2xl:py-2 3xl:py-4 py-1 rounded" @keyup="customTipHandler"/>
            </div>
        </div>
