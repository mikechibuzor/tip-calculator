<template>
  <div class="akin w-screen xl:h-screen flex flex-col items-center justify-center bg-light-grayish-cyan1" @click.self="activeButtonHandler">

    <!-- title starts -->
    <div class="title mt-8 xl:-mt-16 ">
      <h1 class="text-very-dark-cyan font-space-mono font-bold text-2xl 2xl:text-5xl">SPLI
        <br />
        TTER
      </h1>
    </div>
    ...
    <div class="tip-calculator-container grid grid-cols-1 xl:grid-cols-2 px-8 py-6  3xl:py-12 gap-x-10 gap-y-10 mt-8 xl:mt-16   xl:w-3/5  bg-white rounded-xl xl:rounded-3xl">
      <div id="first-half" class="first-half  rounded-xl ">
        <div class="bill">
          <label for="bill" class="font-space-mono text-dark-grayish-cyan1 2xl:text-lg 2xl:mb-2 3xl:mb-2.5 font-bold block mb-1.5">Bill</label>
          <div class="input-box relative flex items-center ">
            ...
            <input v-model="bill" type="number" class="w-full outline-none text-right font-bold text-very-dark-cyan text-xl font-space-mono 2xl:py-3.5 3xl:py-5 py-2 pl-8 2xl:pl-16 pr-4 transition-all duration-300 ease-in-out rounded bg-light-grayish-cyan2" placeholder="0">
          </div>
        </div>
        ...
        <div class="select-tip mt-8 2xl:mt-9 custom-breakpoint:mt-14 3xl:mt-16">
            ...
            <div class="options grid grid-cols-3 gap-x-4 2xl:gap-x-6 gap-y-4">
              ...
              <button id="10" class="rounded-md tb hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 2xl:py-3 3xl:py-4   py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan " @click="activeButtonHandler">10%</button>
              <button id="15" class="rounded-md tb hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 2xl:py-3 3xl:py-4  py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan " @click="activeButtonHandler">15%</button>
              <button id="25" class="rounded-md tb hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 2xl:py-3 3xl:py-4  py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan " @click="activeButtonHandler">25%</button>
              <button id="50" class="rounded-md tb hover:bg-light-grayish-cyan1 hover:text-very-dark-cyan duration-100 ease-linear px-4 2xl:py-3 3xl:py-4   py-1.5 text-white font-space-mono font-bold text-xl bg-very-dark-cyan " @click="activeButtonHandler">50%</button>
              <input type="number" v-model="customTip"  placeholder="Custom" class="custom outline-none font-space-mono bg-light-grayish-cyan2 px-4 2xl:py-2 3xl:py-4 py-1 rounded" @keyup="customTipHandler"/>
            </div>
        </div>
        ...
        <div class="number-of-people mt-6  2xl:mt-10 custom-breakpoint:mt-14 3xl:mt-16">
          <div class="div flex items-center justify-between">
            ...
            <div class="input-box relative flex items-center ">
              ...
              <input v-model="numberOfPeople" type="number" min="0" :class="validateError" class="w-full outline-none text-right font-bold text-very-dark-cyan text-xl font-space-mono 2xl:py-3.5 3xl:py-5 py-2 pl-8 2xl:pl-16 pr-4 transition-all duration-300 ease-in-out rounded bg-light-grayish-cyan2" placeholder="0" @change="numberOfPeopleHandler" @keyup="numberOfPeopleHandler">
            </div>         
        </div>
      </div>
      <div class="second-half  flex flex-col justify-between rounded-xl bg-very-dark-cyan shadow-sm  3xl:p-12 p-8">
       ...
       <div class="reset-button mt-14 xl:mt-0">
         <button :class="disableButtonClass" class="outline-none  hover:bg-light-grayish-cyan1 2xl:py-4 3xl:py-5  hover:text-very-dark-cyan duration-100 ease-linear border-none text-very-dark-cyan font-space-mono font-bold bg-strong-cyan w-full px-8 py-2.5 rounded text-lg" @click="resetButtonHandler">RESET</button>
       </div>
      </div>
    </div>
